...
public class PersonProjectTest {
	...
	public void testAll() {
		...
		try {
			URI uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/people");
			...
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/"+personEntity1.getBody().getId());
			Project proy = new Project();
			proy.setName("mayhem");
			ResponseEntity<Project> projectEntity1 = restTemplate.postForEntity(uri, proy, Project.class);
			
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/"+personEntity2.getBody().getId());
			proy = new Project();
			...
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/"+personEntity3.getBody().getId());
			proy = new Project();
			proy.setName("pepitoproy");
			ResponseEntity<Project> projectEntity4 = restTemplate.postForEntity(uri, proy, Project.class);
			
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/"+personEntity1.getBody().getId()+"/page/0/size/100/sort/NAME");
			...
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/"+personEntity2.getBody().getId()+"/page/0/size/100/sort/NAME");
			...
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/name/"+personEntity1.getBody().getName());
			ResponseEntity<List> owner1List = restTemplate.getForEntity(uri, List.class);
			assertEquals(2, owner1List.getBody().size());
			
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/names/jose-pepe");
			ResponseEntity<List> projectList = restTemplate.getForEntity(uri, List.class);
			
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/owner/names/jose-pepe/ids/1-20");
			ResponseEntity<List> projectList2 = restTemplate.getForEntity(uri, List.class);
			
			try{
				uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/Q/owner/names/jose-pepe/ids/1-20");
				ResponseEntity<List> projectList3 = restTemplate.getForEntity(uri, List.class);
			}catch(Exception e){}
			
			uri = new URI("http://localhost:8080/SpringDataJpaQueryDslTestProject/action/projects/Q2/owner/names/jose-pepe/ids/1-20");
